...
public class CommonExceptionAdvice {
    ...
    * */
    ...
    // @ExceptionHandler : 특정 예외 타입을 처리하는 메서드 지정, Exception.class는 모든 예외를 처리하겠다는 의미
    public String except(Exception ex, Model model) {

        // Exception ex : 예외 정보를 담고 있는 객체
        // Model model  : 데이터 전달용 객체(request scope가 기본), 뷰로 예외 정보를 전달하기 위해 사용
